...
import heals from '../assets/Heals.jpg';
import flats from '../assets/flats.jpg';
import flipflop from '../assets/flipflop.jpg';
...
const Vegetable = () => {
    ...
    const vegetables = [
        { id: 1, name: 'Crocs', price: '₹3500', imgSrc: crocs },
        { id: 2, name: 'Heals', price: '₹2450', imgSrc: heals },
        { id: 3, name: 'Flats', price: '₹350', imgSrc: flats },
        { id: 4, name: 'FlipFlop', price: '₹600', imgSrc: flipflop },
