            ...
            <div style={{
                ...
                <div style={{ flex: 1, margin: '0 10px' }}>
                    ...
                    <ul style={{ listStyleType: 'none', padding: 0, color: 'white' }}>
                        ...
                        <li style={{ marginBottom: '5px', color: 'white' }}>For issues, email us at <a href="mailto:freshbasket@gmail.com" style={{ color: 'white', textDecoration: 'none' }}>freashbasket@gmail.com</a></li>
                    </ul>
                </div>
            </div>
        </footer>
